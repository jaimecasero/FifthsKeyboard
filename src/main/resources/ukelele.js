...
(function (window, document, undefined) {
    ...
    function init() {
        ...
        STRING_SEPARATION = fretCanvas.width / STRING_OFFSET.length;
...
function renderFretboard() {
    ...
    //draw strings
    for (let i=0; i < STRING_OFFSET.length ; i++) {
        ctx.beginPath();
